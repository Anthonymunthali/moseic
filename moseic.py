...
'''
This project aimed to accomplish the same manual photo manipulation that was done in this video though not exactly there yet: https://www.youtube.com/watch?app=desktop&si=Nqc-NEpuzXhmFmRC&v=f1fXCRtSUWU&feature=youtu.be
'''
...
def main():
    im = Image.open(r"C:\Users\user\Pictures\snaps\1.png")  # Add file path for your image
